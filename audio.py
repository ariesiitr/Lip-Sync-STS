...
def get_hop_size():
    hop_size = hp.hop_size  #number of samples between each successive FFT window
    if hop_size is None:
...
#the algorithm randomly initializes phase estimates, and then alternates forward- and inverse-STFT operations
def _griffin_lim(S):
